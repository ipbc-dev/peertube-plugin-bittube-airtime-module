...
export function injectLinkAccountButton() {
    ...
    if (buttonDOM == null || buttonDOM == undefined) { /* If the button is already rendered, do nothing */
        ...
        const link1 = createLinkIcon(icon1, 'Get Airtime extension', 'https://bittube.app', 'airtime-linking-extra-links-with-icon')
        const link2 = createLinkIcon(icon2, 'Learn more about Airtime', 'https://kb.bittubeapp.com/article/152-what-is-the-purpose-of-the-bittube-browser-extension-on-bittubers-com', 'airtime-linking-extra-links-with-icon')
        /* Links container */
        const linkAccountLinks = document.createElement('div')
        linkAccountLinks.className = "airtime-linking-extra-links-container"
        linkAccountLinks.appendChild(link1)
        linkAccountLinks.appendChild(link2)
        /* Button */
